...
# rustup completions (generates them on the fly)
zinit ice id-as"rustup" as"completion" nocompile \
  atclone"rustup completions zsh > _rustup" \
  atpull"%atclone" src"_rustup"
...
# notes related
alias todo="nvim ~/second-brain/TODO.md"
